...
public class NormalNoiseGlassDriver {
    ...
    public static void main(String[] args) throws IOException {
        String inputFile1 = "/data/glass.data";
        try {
            InputStream input = NormalNoiseGlassDriver.class.getResourceAsStream(inputFile1);
            ...
            stdin.close();
            input = NormalNoiseGlassDriver.class.getResourceAsStream(inputFile1);
